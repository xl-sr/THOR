...
static PyMethodDef __pyx_mdef_6region_5vot_float2str = {"vot_float2str", (PyCFunction)__pyx_pw_6region_5vot_float2str, METH_VARARGS|METH_KEYWORDS, 0};
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  if (PyObject_SetAttrString(__pyx_m, "RegionBounds", (PyObject *)&__pyx_type_6region_RegionBounds) < 0) __PYX_ERR(0, 17, __pyx_L1_error)
  ...
  if (PyObject_SetAttrString(__pyx_m, "Rectangle", (PyObject *)&__pyx_type_6region_Rectangle) < 0) __PYX_ERR(0, 56, __pyx_L1_error)
  ...
  if (PyObject_SetAttrString(__pyx_m, "Polygon", (PyObject *)&__pyx_type_6region_Polygon) < 0) __PYX_ERR(0, 97, __pyx_L1_error)
